    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center text-center">
        <div>
          ...
          <p className="text-gray-500">Please connect your wallet to view available courses.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="sticky top-0 bg-white/80 backdrop-blur border-b z-40 px-6 py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-indigo-600 text-white px-4 py-2 rounded-full text-sm flex items-center gap-2">
              <Zap size={16} />
